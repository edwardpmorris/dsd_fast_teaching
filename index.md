...
#- company: NIOZ
#  name: Bas Oteman
date: "Delft Software Days 2015-10-27"
...
<q>Light enables us to see the world around us. The capacity of light to carry and convey information is perhaps its most important, and remarkable, characteristic.  </q>
...
<iframe src="https://www.youtube.com/embed/gF9UlTYR5d0?autoplay=1;controls=0&amp;showinfo=0;frameborder=-1" width="854" height="480" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
...
<iframe src="http://www.nhm.ac.uk/visit/wpy/gallery/2015/images/from-the-sky/5014/the-art-of-algae.html" width="600" height="480" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
...
+ effective antena size much larger due to clever processing (Synthetic Aperture)
+ allows increased spatial resolution
+ measures polarised radio waves (horizontal and vertical)
...
<div>
<pw>
<img alt="radar-bands.jpg" src="assets/img/radar-bands.jpg" width=500px style="margin:10px 0px"> "A geometric model of a SAR system" by <a href="http://www.slideshare.net/hiteshchandanshive/radar-44309271">Hitesh Chandanshive </a>.
</pw>
</div>

*** =right

+ most common bands are C and X
+ band wavelength determines the application (i.e., the size and penetration)

<div>
<pw>
<img alt="radar-bands-penetration.jpg" src="assets/img/radar-bands-penetration.jpg" width=500px style="margin:10px 0px"> "Short wavelength X-band RADAR energy reflects from canopy surface while long wavelength P-band energy penetrates through canopy and reflects from stems and terrain surface " by <a href="http://forsys.cfr.washington.edu/JFSP06/radar_overview.htm">http://forsys.cfr.washington.edu/JFSP06/radar_overview.htm </a>, adapted from Moreira et al. (2001).
</pw>
</div>
...
+ surfaces have specific scattering and absorption properties (also for polarised waves)
    + water tends to be a specular reflector of radio waves (usually not recollected by sensor)
    + complex interactions with vegetation can result in specific return signals 

*** =right

<div>
<pw>
<img alt="canopy-radar.jpg" src="assets/img/canopy-radar.jpg" width=500px style="margin:10px 0px"> "Surface and volume scattering of a SAR beam for trees " by (<a href="http://www.intechopen.com/books/advances-in-geoscience-and-remote-sensing/forest-inventory-using-optical-and-radar-remote-sensing">Fernandez-Ordonez et al. 2009.</a>).
</pw>
</div>
...
+ Sentinel Application Platform (SNAP); official software for processing sentinel data
...
+ [Python bindings]()
+ Sensor specific toolboxes (Sentinels, but also other sensors)
+ Developed by [Brockman Consult]() and [Array Systems Computing]() for ESA
...
+ run from within the GUI or the commandline (GPT)
+ ??access via Python??
...
+ FAST WP3, 4 and 5 teams for support and contributions.
...
+ spatially subset the product
+ apply at-sensor and top-of-atmosphere calibration (convert to sigma0).
+ apply a speckle filter.
+ apply elipsoid correction (georeference).
+ convert to decibels (log-linear scale?).
+ examine the image.
+ export data.

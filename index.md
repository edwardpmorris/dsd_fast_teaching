...
#- company: NIOZ
#  name: Bas Oteman
date: "Delft Software Days 2015-10-28"
...
+ interactions can vary wih the beam polarization.
...
+ [Sentinel Application Platform (SNAP)](http://step.esa.int/main/download/); official software for processing sentinel data, replaces NEST.
...
+ [OTB](https://www.orfeo-toolbox.org); C
...
+ Developed by Array (S-1), C-S (S-2) and Brockmann Consult (S-3) for ESA.
